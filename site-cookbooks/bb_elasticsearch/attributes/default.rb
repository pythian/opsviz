# Default to 1.6.0 and allow for overrides in the custom_json
normal[:elasticsearch][:version] = '1.6.0'

# 1.6.0
if node[:elasticsearch][:version] == '1.6.0'
    ...
    normal[:elasticsearch][:plugins]["elasticsearch/elasticsearch-cloud-aws"]["version"] = "2.6.0" 
end
# 1.5.2
if node[:elasticsearch][:version] == '1.5.2'
    ...
    normal[:elasticsearch][:plugins]["elasticsearch/elasticsearch-cloud-aws"]["version"] = "2.5.1" 
end
# 1.4.4
if node[:elasticsearch][:version] == '1.4.4'
    ...
    normal[:elasticsearch][:plugins]["elasticsearch/elasticsearch-cloud-aws"]["version"] = "2.4.2" 
end
