...
echo "$SCHEME.Committed_Heap $TotalHeap `date '+%s'`"
echo "$SCHEME.Used_Heap $UsedHeap `date '+%s'`"
echo "$SCHEME.Eden_Util $ParEden `date '+%s'`"
echo "$SCHEME.Survivor_Util $ParSurv `date '+%s'`"
echo "$SCHEME.Old_Util $OldGen `date '+%s'`"
echo "$SCHEME.Perm_Util $PermGen `date '+%s'`"
